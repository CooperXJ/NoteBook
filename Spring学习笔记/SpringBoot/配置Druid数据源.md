...
![image-20200810145539875](https://raw.githubusercontent.com/CooperXJ/ImageBed/master/img/20200810145916.png)
...
**<font color=red>在此处也体现了Servlet和Filter注册的方法（相当于在web.xml中对Servlet和Filter进行配置）</font>**
...
public ServletRegistrationBean statViewServlet() {
    ...
    initParams.put("loginUsername", "admin"); //后台管理界面的登录账号  loginUsername不能写成其他的
    initParams.put("loginPassword", "123456"); //后台管理界面的登录密码 loginPassword不能写成其他的
